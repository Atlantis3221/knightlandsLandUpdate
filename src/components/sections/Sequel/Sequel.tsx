...
const Sequel = () => {
    return (
        <div data-aos="fade-up" className={styles.container + " w-full relative z-10 overflow-x-hidden"}>
            <div className={styles.sequelWrapper + ` mx-auto w-full xl:max-w-6xl relative flex justify-center w-full`}>
                ...
                <div className={styles.sequelBackground + ' flex w-full flex-col h-full z-10 relative items-center px-4 sm:px-16 py-10'}>
