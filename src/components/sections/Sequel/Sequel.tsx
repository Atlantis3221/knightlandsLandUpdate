...
const Sequel = () => {
    return (
        <div data-aos="fade-up" className={styles.container + " w-full relative z-10 overflow-hidden"}>
            <div className={styles.sequelWrapper + ` mx-auto w-full xl:max-w-6xl relative flex justify-center w-full`}>
                <div className={styles.sequelBackground + ' flex w-full h-full z-10 relative items-center px-4 md:px-16 lg:pt-16 pt-0 pb-8 sm:pb-16'}>
                    <div className="w-full lg:w-2/3 xl:w-1/2 flex flex-col text-center lg:text-left ">
                        {/* <div className="-my-10 block lg:hidden">
                            <SequelIcon />
                        </div> */}
                        <div className={styles.logo + " relative -my-6 sm:-my-12 lg:absolute lg:w-1/2 lg:-top-12 lg:-right-10"}>
                            <SequelIcon />
                        </div>
                        ...
                        <div className="w-full flex">
                            <a href="https://play.knightlands.com" className="mx-auto lg:mx-0" target="_blank">
