...
const MainInfo = () => {
  return (
    <div data-aos="fade-up" className="flex flex-col items-center mb-36" id={HeaderLink.MAIN}>
      <div className="flex flex-col lg:-mt-24 xl:-mt-52 items-center lg:flex-row w-full text-center md:items-start lg:items-center md:text-left overflow-x-hidden lg:overflow-x-visible">
      ...
      <div className="flex flex-col items-center lg:items-start w-full lg:-mt-12 xl:-mt-40 mb-16">
