...
const Features = () => {
  return (
    <div data-aos="fade-up" className="grid grid-cols-1 lg:grid-cols-4 w-full mb-8 gap-x-4 gap-y-8 w-full ">
      <div className={styles.feature + " h-full pt-8 pb-8 lg:pt-0 flex flex-row-reverse lg:flex-col relative overflow-hidden lg:overflow-visible lg:items-center"}>
        <div className="absolute bottom-0 -right-4 sm:right-0 w-56 sm:w-2/5 lg:w-120p my-auto lg:my-0 h-48 flex items-center justify-end lg:justify-center md:h-full lg:h-32 sm:relative">
          <img src="/main/map.png" className="absolute bottom-0 lg:-bottom-4 xl:-bottom-7 w-full sm:w-auto h-auto sm:h-full lg:h-auto lg:w-auto" />
        </div>
      ...
      <div className={styles.feature + " h-full pt-8 pb-8 lg:pt-0 flex flex-row-reverse lg:flex-col relative overflow-hidden lg:overflow-visible lg:items-center"}>
        <div className="flex absolute bottom-0 right-0 sm:right-0 w-56 sm:w-2/5 lg:w-120p my-auto lg:my-0 h-48 flex items-center justify-end lg:justify-center md:h-full lg:h-32 sm:relative ">
