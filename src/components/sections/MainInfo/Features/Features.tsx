...
const Features = () => {
  return (
    <div data-aos="fade-up" data-aos-delay={500} className="grid grid-cols-1 lg:grid-cols-3 w-full mb-8 gap-x-4 gap-y-4 w-full px-4">
      <div className={styles.feature + " h-full py-8 flex flex-row-reverse lg:flex-col relative"}>
