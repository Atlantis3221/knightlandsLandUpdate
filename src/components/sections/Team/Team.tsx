...
const data: ITeamMember[] = [
  ...
  { src: '/team/team7.png', name: 'Martin Isla', role: 'Programmer', url: null, description: '7 years of experience making video games that range from tiny experiences to MMOs for mobile, PC and VR platforms. Passionate about gameplay programming and making things feel good.' },
  ...
  { src: '/team/team10.png', name: 'Matias Paredes', role: 'Developer', url: null, description: '6 years of game design experience working in 2D, 3D and VR games for mobile and PC platforms' },
];
