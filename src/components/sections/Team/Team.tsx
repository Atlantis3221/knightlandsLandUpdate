...
const data: ITeamMember[] = [
  ...
  { src: '/team/team2.png', name: 'Andrey Pavlychev', role: 'Art and Design', url: 'https://linkedin.com/in/drawnpro', description: '14 years of experience being a 2D and User Interface artist, specializing in artwork production for mobile and social network games, ex-Gameloft.' },
